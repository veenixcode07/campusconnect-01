...
CREATE POLICY IF NOT EXISTS "Faculty and admin can manage students"
ON public.students
FOR ALL
USING (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Students can view their own student row"
ON public.students
FOR SELECT
USING (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Faculty and admin can manage attendance records"
...
CREATE POLICY IF NOT EXISTS "Students can view their own attendance records"
ON public.attendance_records
FOR SELECT
USING (
  EXISTS (
...
-- Faculty/Admin can manage all
CREATE POLICY IF NOT EXISTS "Faculty and admin can manage attendance logs"
...
CREATE POLICY IF NOT EXISTS "Students can view their own attendance logs"
ON public.attendance_logs
FOR SELECT
USING (
  EXISTS (
